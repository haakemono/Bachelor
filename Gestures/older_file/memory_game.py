...
print("🔙 Press 'Q' or 'ESC' to return to the menu at any time.")
...
# **Return to Menu Without Opening a New Window**
menu_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "menu.py")
print(f"🔄 Returning to Menu: {menu_path}")

os.execv(sys.executable, ["python", menu_path])  # Replaces current process with menu.py
