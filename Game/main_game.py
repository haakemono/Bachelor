        ...
        while True:
            ...
            if not game_state["game_over"]:
                ...
                if basket_x is not None:
                    game_state["player"].x = basket_x - PLAYER_WIDTH // 2
                ...
                # Collision detection
                game_state["apples"] = [a for a in game_state["apples"] if a[1] < HEIGHT]
                game_state["bombs"] = [b for b in game_state["bombs"] if b[1] < HEIGHT]
